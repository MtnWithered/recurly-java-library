...
public class TestUtils {
    ...
    public static Delivery createRandomDelivery(final int seed) {
        ...
        delivery.setEmailAddress(randomAlphaNumericString(10) + "@email.com");
        delivery.setFirstName(randomAlphaNumericString(5));
        delivery.setLastName(randomAlphaNumericString(5));
        delivery.setGifterName(randomAlphaNumericString(5));
        delivery.setMethod("email");
        delivery.setPersonalMessage(randomAlphaNumericString(100));
